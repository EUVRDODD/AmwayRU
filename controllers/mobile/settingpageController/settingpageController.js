  ...
  goToSettingsPostshow : function(){
    try{
      ...
      callTealiumOnScreenLoad(this.view.id,additionalArg,null,false);
       ...
       kony.print(" >>> Tealium track view Exception "+ex);
      }
...
*/
  goToLogoutYes : function(){
    ...
    var onClickDetails = {
        "event_name":"click_action",
        "click_detail":"Logout_Yes"
    	 };
     callTealiumOnClick(onClickDetails,["btnLogoutYes"], false);
  ...
  goToLogoutNo : function(){
    ...
    var onClickDetails = {
        "event_name":"click_action",
        "click_detail":"Logout_No"
    	 };
     callTealiumOnClick(onClickDetails,["btnLogoutNo"], false);

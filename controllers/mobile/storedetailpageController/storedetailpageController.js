define({
  ...
  sendEmail: function() {
    ...
    var onClickDetails = {
        ...
        "click_detail":"StoreDetail_Email"
    	 };
     callTealiumOnClick(onClickDetails,["btnEmailAdd"], false);
  ...
  openPhoneService: function() {
    try {
      ...
      var onClickDetails = {
        "event_name":"click_action",
        "click_detail":"StoreDetail_Phone"
    	 };
     callTealiumOnClick(onClickDetails,["btnNumber"], false);
  ...
  openMaps: function() {
    ...
    var onClickDetails = {
        "event_name":"click_action",
        "click_detail":"StoreDetail_Map"
    	 };
    callTealiumOnClick(onClickDetails,["btnOpenMaps"], false);
    var latitude = storeData["btnmapOpen"]["info"]["latitude"];
    var longitude = storeData["btnmapOpen"]["info"]["longitude"];

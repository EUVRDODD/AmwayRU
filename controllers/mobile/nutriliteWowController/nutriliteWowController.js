  ...
  setUrlToBrowser:function(){
    ...
    try{
      ...
      if (!isBlankOrNull(urlData))
      {
        ...
        if ((!isBlankOrNull(urlData.contentType) && urlData.contentType === "html") )
        {
          ...
          if(urlData === "Shop Online"){
            url="http://www.amway.in/store/?cid=content-hub-app";
            ...
            url="http://www.amway.in/store/amway/en/INR/lmsSearch/lmsHandler?LMSURL=https%3a%2f%2findia.amwayuniversity.com%2fcourses%2fapp%2fmanagement%2fLMS_CNT_SilentLaunch.aspx%3fUserMode%3d0%26ActivityId%3d2555%26lang%3den-US&cid=content-hub-app";
          }else if(urlData === "Nutrilite Product Recommender"){
            url="http://nutriliterecommender.amway.in/?cid=content-hub-app" ;
          }else if(urlData === "Artistry Skincare Recommender"){
            url="http://artistryrecommender.amway.in/?cid=content-hub-app" ;
          }else if(urlData === "MyBiz") {
            url = "https://mybiz.amway.com/?cid=content-hub-app";
      ...
      else
      {
        ...
        var urlConf = {
          URL : "https://www.nutrilitewow.com/?cid=content-hub-app",
          requestMethod:constants.BROWSER_REQUEST_METHOD_GET
        };

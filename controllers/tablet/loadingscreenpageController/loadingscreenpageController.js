define({
  ...
  applyBinding : function(){
    kony.print("@@@ applyBinding in loading page");
    ...
    this.view.video1.onCompletion = this.onCompletionVideoLoadingScreen.bind(this);
    this.view.video1.onPrepared = this.onPreparedVideoLoadingScreen.bind(this);
  },
  onCompletionVideoLoadingScreen: function() {
    try{
      ...
      kony.print("Exception in onCompletionVideoLoadingScreen "+e);
    }
  ...
  onPreparedVideoLoadingScreen: function() {
    try{
      this.view.video1.play();
    }catch(e){
      kony.print("Exception in play");
    }

  },
  navigationFromLoading:function(){
    if (gblStartupForm == "homepage") {
      kony.print("Hello Navigation to home form ");
      LoggedIn=true;

define(function() {
  ...
  return {
    constructor: function(baseConfig, layoutConfig, pspConfig) {
      this.view.btnphoneCall.onClick = this.openPhoneService.bind( this );
      this.view.btnsendEmail.onClick = this.sendEmail.bind( this );
      this.view.btnmapOpen.onClick = this.openMap.bind( this );
    },
